...
discovering, and deleting supported Learn objects. For a more complete tutorial, check out this [page](rest-api-with-java-command-line.md) to walkthrough building a Java command-line application.
